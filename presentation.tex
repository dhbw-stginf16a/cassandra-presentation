...
\begin{frame}{Wide Column Store}  % TODO cite
  \begin{center}
...
\begin{frame}{General Use-Case Conditions}
%Abstract UseCases
 \begin{itemize}
    ...
    \item<4-> Evolving applications (Add/Remove columns)
 \end{itemize}
...
\begin{frame}{Suitable Use-Cases}
  Concrete use-cases
  \begin{itemize}
...
\begin{frame}{Write process \cite{datastaxWriteData}}
  \begin{center}
    ...
    \begin{enumerate}
      \item<+-> Write to journal to disk in temporal order
      \item<+-> Write to memtable in \textbf{sorted} order
