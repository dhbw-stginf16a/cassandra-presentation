...
\begin{frame}{Deployments}
  ...
  \begin{tabular}{@{}ll}
    \hline
    CERN    & Storage backend for ATLAS detector \tinycite{cern} \\
    \hline
    Netflix & 2,500 nodes, 420 TB, over 1 trillion requests per day \\
            & Migrated from Oracle to Cassandra \tinycite{netflix} \\
    \hline
    eBay    & 6 billion writes and 5 billion reads daily \\
            & Single Cassandra table of 40TB \tinycite{ebay, ebay2} \\
    \hline
    \onslide<2->
    Apple   & >75k Cassandra nodes with \textbf{10PB} in production \\
            & Several clusters with \textbf{1000+ nodes each!} \tinycite{apple} \\
    \hline
  \end{tabular}
...
\begin{frame}{Suitable Use-Cases \tinycite{netflix, apple, ebay}}
  Concrete use-cases
  \begin{itemize}
    \item<1-> Recording of transactions
      \begin{itemize}
        \item{Shopping cart (fraud detection) \tinycite{usecaseFraud}}
...
\begin{frame}{CAP Theorem \tinycite{cassandraInCAPtheorem}}
  \begin{itemize}
    \item AP by default
